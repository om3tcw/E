...
({
  ...
  modules: {
    settings: {
      active: 1,
      rank: -1,
      url: "https://cdn.jsdelivr.net/gh/ramarble/marbl@staging/js/customsettingsmodal.js",
      done: true,
    },
    playlist: {
      active: 1,
      rank: -1,
      url: "https://cdn.jsdelivr.net/gh/ramarble/marbl@staging/js/playlistenhancement2.js",
      done: true,
    },
    privmsg: {
      active: 1,
      rank: 1,
      url: "https://cdn.jsdelivr.net/gh/ramarble/marbl@staging/js/pmenhancement.js",
      done: true,
    },
    notifier: {
      active: 1,
      rank: -1,
      url: "https://cdn.jsdelivr.net/gh/ramarble/marbl@staging/js/notifier.js",
      done: true,
    },
    layout: {
      active: 1,
      rank: -1,
      url: "https://cdn.jsdelivr.net/gh/ramarble/marbl@staging/js/layoutoptions.js",
      done: true,
    },
    userlist: {
      active: 1,
